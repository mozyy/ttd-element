...
// EXTERNAL MODULE: ./packages/input/index.js + 7 modules
...
var scrollbar = __webpack_require__(45);
...
var external_resize_observer_polyfill_ = __webpack_require__(56);
...
var resize_event_resizeHandler = function resizeHandler(entries) {
  for (var _iterator = entries, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : get_iterator_default()(_iterator);;) {
    var _ref;
...
var get_prototype_of_ = __webpack_require__(57);
  ...
  function template(string) {
    ...
    return string.replace(RE_NARGS, function (match, prefix, i, index) {
      ...
      if (string[index - 1] === '{' && string[index + match.length] === '}') {
        ...
        result = Object(util_["hasOwn"])(args, i) ? args[i] : null;
...
var locale_i18nHandler = function i18nHandler() {
  var vuei18n = get_prototype_of_default()(this || external_vue_default.a).$t;
...
/* harmony default export */ var src_locale = ({ use: use, t: t, i18n: i18n });
...
/* harmony default export */ var selectvue_type_script_lang_js_ = ({
  mixins: [emitter, locale["a" /* default */], mixins_focus('reference'), navigation_mixin],
  name: 'ElSelect',
  ...
  computed: {
    ...
    readonly: function readonly() {
      return !this.filterable || this.multiple || !Object(util["f" /* isIE */])() && !Object(util["e" /* isEdge */])() && !this.visible;
    },
