...
var RTC = function () {
  ...
  (0, _createClass3.default)(RTC, [{
    ...
    key: 'createStream',
    value: function createStream(uid) {
      var _this3 = this;
      ...
      localStream.init(function () {
        _this3.log('获取媒体成功');
        localStream.play(_agora.customerServiceId);
