...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"el-pdf-label"},[_c('i',{staticClass:"el-pdf-label__turn el-icon-arrow-left",class:{'is-disable':_vm.leftDisable},on:{"click":_vm.turnLeft}}),_c('ttd-pdf',{ref:"pdf",staticClass:"el-pdf-label__pdf",attrs:{"src":_vm.src,"page-number":_vm.page,"page-total":_vm.pageTotal,"page-change":_vm.pageChange}},[_vm._l((_vm.currentLabels),function(label,index){return _c('ttd-pdf-label-item',{key:index,attrs:{"label":label,"active":_vm.active===index},on:{"deleteLabel":_vm.deleteLabel},nativeOn:{"click":function($event){_vm.active = index}}})}),(_vm.newLabel)?_c('ttd-pdf-label-item',{attrs:{"label":_vm.newLabel,"pure":""}}):_vm._e()],2),_c('i',{staticClass:"el-pdf-label__turn el-icon-arrow-right",class:{'is-disable':_vm.rightDisable},on:{"click":_vm.turnRight}})],1)}
var staticRenderFns = []
