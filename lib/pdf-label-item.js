...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_67526350_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_pdf_label_item_vue__ = __webpack_require__(271);
...
exports.default = {
  ...
  data: function data() {
    return {
      labeled: this.pure ? this.label : (0, _extends3.default)({}, this.label)
    };
  },
  ...
  computed: {
    style: function style() {
      var _labeled = this.labeled,
          xAxis = _labeled.xAxis,
          yAxis = _labeled.yAxis,
          labelWidth = _labeled.labelWidth,
          labelHigh = _labeled.labelHigh;
  ...
  methods: {
    ...
    generateDragStart: function generateDragStart(type) {
      ...
      return function (_ref) {
        ...
        if (type === 'box') {
          _this.startLeft = _this.labeled.xAxis;
          _this.startTop = _this.labeled.yAxis;
        } else if (type === 'scale') {
          _this.startWidth = _this.labeled.labelWidth;
          _this.startHeight = _this.labeled.labelHigh;
        }
      };
    },
    generateDrag: function generateDrag(type) {
      ...
      return function (_ref2) {
        ...
        if (type === 'box') {
          _this2.labeled.xAxis = clientX - _this2.startX + _this2.startLeft;
          _this2.labeled.yAxis = clientY - _this2.startY + _this2.startTop;
        } else if (type === 'scale') {
          _this2.labeled.labelWidth = clientX - _this2.startX + _this2.startWidth;
          _this2.labeled.labelHigh = clientY - _this2.startY + _this2.startHeight;
        }
      };
    },
