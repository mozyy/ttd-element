...
<html lang="en">
  <head>
    ...
    <title>Element</title>
  <link rel="shortcut icon" href="favicon.ico"><link href="ttd-element.91d081c.css" rel="stylesheet"><link href="docs.c756e1f.css" rel="stylesheet"></head>
  <body>
    <script>
      if (!window.Promise) {
  ...
  <script type="text/javascript" src="manifest.dfffefe.js"></script><script type="text/javascript" src="ttd-element.dfffefe.js"></script><script type="text/javascript" src="docs.dfffefe.js"></script></body>
  <script>
